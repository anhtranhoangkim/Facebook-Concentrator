...
const contacts = document.querySelectorAll('ul.x1hc1fzr')
...
// Stories
const stories = document.querySelectorAll('div.x193iq5w.xgmub6v.x1ceravr')
...
//  Shortcuts
const shortcuts = document.querySelectorAll('div.xwib8y2 + ul')
...
// Enable Quotes
const newfeedQuote = document.querySelectorAll('div.x1hc1fzr.x1unhpq9.x6o7n8i')

for(let i = 0; i < newfeedQuote.length; i++) {
    newfeedQuote[i].innerHTML += 
        `<h3 style="color:  #fff;font-size: 1.4rem;text-align: left;">${randomQuote.quote}</h3>
        <h4 style="color: #b0b0b0;font-size: 1rem;text-align: end;padding-top: 0.6rem;">- ${randomQuote.author} -</h4>`;
}